...
class MainWindow(QMainWindow):
    def __init__(self, node):
        ...
        # All sliders now have a range of 0 to 180 degrees
        self.joint_names = ["base_joint", "joint2", "joint3", "joint4", "end_effector_joint"]
        self.joint_ranges = [(0, 180), (0, 180), (0, 180), (0, 180), (0, 180)]
        self.current_values_deg = [90.0] * 5 # Start all sliders at a neutral 90 degrees
        ...
        for i, (name, (min_val, max_val)) in enumerate(zip(self.joint_names, self.joint_ranges)):
            ...
            slider.setValue(90)
            # Connect the slider's valueChanged signal directly to the publish method
